package com.wzb.setting.interf;
...
import com.wzb.setting.util.SharedPreferencesUtil;
...
public class WApplication extends Application {
	...
	public void onCreate() {
		...
		sp = new SharedPreferencesUtil(SP_NAME, SharedPreferencesUtil.OTHER_READ_AND_WRITE, CONTEXT);
